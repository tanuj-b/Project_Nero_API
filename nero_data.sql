...
insert  into `questions`(`id`,`question`,`options`,`answer`,`comments`,`l3_id`,`difficulty`,`average_time`,`question_type_id`,`question_set_id`,`flag`) values (1,'q1','yes||no||may be',1,'1 is right because||2 wrong because',NULL,NULL,NULL,1,NULL,1),(2,'q2','opt1||opt2||opt3',2,'explain|explain|explain',NULL,NULL,NULL,1,NULL,1),(3,'q3','o1||o2||o3',3,'ex||ex||ecde',NULL,NULL,NULL,1,NULL,1),(4,NULL,NULL,NULL,NULL,NULL,NULL,NULL,2,'This is cool',1);
